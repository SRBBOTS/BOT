...
URL = "https://bot-jw3c.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://bot-jw3c.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://bot-jw3c.onrender.com/".format(FQDN)
else:
    URL = "https://bot-jw3c.onrender.com/".format(FQDN)
