...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001509866228')
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/hd_top_flix')
...
URL = "https://bot-20hd.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://bot-20hd.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://bot-20hd.onrender.com/".format(FQDN)
else:
    URL = "https://bot-20hd.onrender.com/".format(FQDN)
